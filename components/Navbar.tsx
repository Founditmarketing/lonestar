...
const Navbar: React.FC = () => {
  ...
  const navItems = [
    ...
    { label: 'Design Studio', id: 'design-studio', path: '/design-studio' },
    {
      ...
      path: '/rto',
      dropdown: [
        { label: 'Program Details', path: '/rto' },
        { label: 'Apply Now — No Credit Check', path: 'https://express-fin.com/application-form/?recordId=001UR00000g3tcTYAQ', external: true },
      ]
    },
    ...
    <>
      ...
      >
        <div className={`max-w-7xl mx-auto flex justify-between items-center transition-all duration-500 ${
          isScrolled 
            ? 'bg-white/80 rounded-3xl py-3 px-6 sm:px-8 shadow-2xl shadow-wood-900/5 border border-slate-100' 
          ...
          <div className="hidden lg:flex items-center gap-6">
            <a href="tel:9038860307" className={`font-serif font-bold text-lg hover:opacity-75 transition-opacity tracking-wide ${textColorClass}`}>
              (903)-886-0307
            </a>
            <button 
