            ...
            <div className="col-span-12 md:col-span-7 p-4 md:p-12">
              <form onSubmit={handleSubmit} className="space-y-6 md:space-y-12 pb-24 md:pb-0">
                ...
                <div>
                  ...
                  {/* LightStream Financing Banner */}
                  <div className="mt-8 pt-8 border-t border-slate-100">
                     <h4 className="text-center text-sm font-bold text-slate-400 uppercase tracking-wider mb-6 flex items-center justify-center gap-4">
                       <span className="h-px bg-slate-200 w-12"></span> 
                       Third-Party Financing 
                       <span className="h-px bg-slate-200 w-12"></span>
                     </h4>
                     <a href="https://www.lightstream.com/tiny-houses?cid=AA-14455&irad=191844&fact=14455&irmp=2583109&isredirect=True" target="_blank" rel="noopener noreferrer" className="block w-full max-w-sm mx-auto hover:-translate-y-1 transition-all duration-300 rounded-xl overflow-hidden shadow-lg hover:shadow-xl border border-slate-100 ring-4 ring-transparent hover:ring-wood-500/20">
                        <img src="/lightstream.jpg" alt="Fast and easy tiny home financing. Apply Now. LightStream" className="w-full h-auto object-cover block" />
                     </a>
                  </div>
                </div>
