    ...
    <div className="pt-32 pb-24 bg-wood-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-16">
           ...
           <p className="text-xl text-slate-500 font-light max-w-2xl leading-relaxed mb-8">
        ...
        <div className="bg-white rounded-[2.5rem] p-10 md:p-16 border border-slate-100 shadow-2xl shadow-wood-900/5">
          ...
          <div className="mt-10 pt-8 border-t border-slate-100">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-slate-900 hover:bg-wood-800 text-white font-bold px-8 py-4 rounded-full shadow-lg hover:-translate-y-0.5 transition-all group"
            >
