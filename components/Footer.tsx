...
import { Facebook, Hammer, FileText, MapPin, ShieldCheck, CreditCard } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 border-b border-slate-800 pb-12">
        <div className="md:col-span-1">
          ...
          <div className="flex gap-4">
            <a href="https://www.facebook.com/lonestarshedsllc/" target="_blank" rel="noopener noreferrer" className="bg-slate-800 p-2 rounded-full hover:bg-wood-500 hover:text-white transition-all">
               <Facebook size={18} />
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-slate-300">
            ...
            <li>
                <Link to="/brochure" className="hover:text-wood-500 transition-colors flex items-center gap-2">
        ...
        <div>
          ...
          <a href="tel:9038860307" className="text-white font-bold hover:text-wood-500 transition-colors block mb-2 text-lg">(903)-886-0307</a>
